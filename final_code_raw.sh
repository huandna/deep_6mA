...
awk -F ',' '$106==1{print}' ${wkd}/${pre}_final_result_${sta}_${end}_coding.csv > ${wkd}/${pre}_${sta}_${end}_coding1.csv
awk -F ',' '$106==0{print}' ${wkd}/${pre}_final_result_${sta}_${end}_coding.csv > ${wkd}/${pre}_${sta}_${end}_coding0.csv
